...
float sdfEyes(vec2 uv) {
    vec2 offset1 = vec2(0.0, sin(iTime + 3.14 * 2.0) + 1.0) * 2.0;
    vec2 offset2 = vec2(sin(iTime + 3.14), 0.0) * 2.0;
    float pupil, eye;
